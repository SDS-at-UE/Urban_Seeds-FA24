...
MonthGRAPH <- product_data %>% 
  ...
  group_by(Product_name, Month, Year) %>% 
...
ui <- navbarPage(leafletjs, theme = shinytheme("cosmo"),
                                       ...
                                       column(3,
                                              wellPanel(
                                                selectInput("selectedProducts", 
                                                            "Select Product(s):", 
                                                            choices = unique(MonthGRAPH$Product_name),
                                                            multiple = T,
                                                            selected = "breakfast bag"),
                                                br(),
                                                selectInput("selectedCustomers", 
                                                            "Select customer(s):", 
                                                            choices = c("", unique(Data$Customer.ID)),
                                                            multiple = T,
                                                            selected = "")
                                              )
                                       )
                 ...
                 tabPanel('Map',  # New tab for the map
                          fluidRow(
                            column(12,
                                   ...
                                   fluidRow(
                                     column(4,
                                            selectInput(inputId = "parameter", "Choose the Parameter:",
                                                        choices = c("Revenue", "Total_number_order"),
                                                        selected = "Revenue")
                                     ),
                                     column(4,
                                            selectInput(inputId = "year", "Select Year:",
                          ...
                          fluidRow(
                            column(12,
                                   leafletOutput("map_pop", width = "100%", height = "800px")  # Adjust the size of the map
                            )
                          )
                 )
)
